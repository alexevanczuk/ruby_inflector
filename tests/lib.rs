// TODO: Uncomment these and convert them to non-metaprogrammatically defined tests
// or just update the metaprogrammatically defined tests to call the methods with a string
